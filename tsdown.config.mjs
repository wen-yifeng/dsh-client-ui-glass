 ...
 *
 * Two faces (2026-09-05: the node half must be rebuilt here too — the host
...
/** Browser face: module-table factory artifact with inlined stylesheets. */
const clientConfig = {
...
export default defineConfig(() => [clientConfig, nodeConfig])
