window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:D:\deepseek-harness\packages\client\ui-glass\src\client\PluginCard.module.css.mjs
		const css$1 = ".ajV3_q_avg_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);border-radius:12px;flex-direction:column;padding:16px;display:flex}.ajV3_q_avg_head{justify-content:space-between;align-items:center;gap:16px;display:flex}.ajV3_q_avg_head+.ajV3_q_avg_head{margin-top:14px}.ajV3_q_avg_text{flex-direction:column;gap:2px;min-width:0;display:flex}.ajV3_q_avg_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:500;line-height:22px}.ajV3_q_avg_description{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}.ajV3_q_avg_toggle{border:1px solid var(--dsw-alias-border-l2);height:28px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:14px;flex:none;align-items:center;gap:6px;padding:0 10px 0 6px;font-size:12px;line-height:18px;display:inline-flex}.ajV3_q_avg_toggle:hover{background:var(--dsw-alias-interactive-bg-hover)}.ajV3_q_avg_toggle[aria-pressed=true]{background:var(--dsw-alias-state-business-tertiary);color:var(--dsw-alias-state-business-primary);border-color:#0000}.ajV3_q_avg_check{justify-content:center;align-items:center;width:16px;height:16px;display:inline-flex}.ajV3_q_avg_actions{flex:none;align-items:center;gap:8px;display:flex}.ajV3_q_avg_actions .ajV3_q_avg_toggle{padding:0 10px}.ajV3_q_avg_toggle:disabled{cursor:default;opacity:.6}.ajV3_q_avg_thumb{border:1px solid var(--dsw-alias-border-l2);background-color:#070809;background-position:50%;background-size:cover;border-radius:6px;flex:none;width:44px;height:30px}";
		...
		var PluginCard_module_css_default = {
			"avg_actions": "ajV3_q_avg_actions",
			"avg_card": "ajV3_q_avg_card",
			"avg_check": "ajV3_q_avg_check",
			"avg_description": "ajV3_q_avg_description",
			"avg_head": "ajV3_q_avg_head",
			"avg_text": "ajV3_q_avg_text",
			"avg_thumb": "ajV3_q_avg_thumb",
			"avg_title": "ajV3_q_avg_title",
			"avg_toggle": "ajV3_q_avg_toggle"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-global-css:D:\deepseek-harness\packages\client\ui-glass\src\client\glass.css.mjs
